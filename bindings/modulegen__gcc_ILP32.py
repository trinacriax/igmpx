...
def module_init():
    root_module = Module('ns.igmpx', cpp_namespace='::ns3')
    return root_module

def register_types(module):
    root_module = module.get_root()
    
    ## neighbor-set.h (module 'video-push'): ns3::PeerPolicy [enumeration]
    module.add_enum('PeerPolicy', ['PS_RANDOM', 'PS_DELAY', 'PS_SINR', 'PS_ROUNDROBIN'], import_from_module='ns.video-push')
    ## video-push.h (module 'video-push'): ns3::ChunkPolicy [enumeration]
    module.add_enum('ChunkPolicy', ['CS_NEW_CHUNK', 'CS_LATEST', 'CS_LEAST_USEFUL', 'CS_LATEST_MISSED', 'CS_LEAST_MISSED'], import_from_module='ns.video-push')
    ...
    ## neighbor-set.h (module 'video-push'): ns3::PeerState [enumeration]
    module.add_enum('PeerState', ['UNKNOWN', 'ACTIVE', 'INACTIVE'], import_from_module='ns.video-push')
    ## video-push.h (module 'video-push'): ns3::PeerType [enumeration]
    module.add_enum('PeerType', ['PEER', 'SOURCE'], import_from_module='ns.video-push')
    ...
    ## chunk-buffer.h (module 'video-push'): ns3::ChunkBuffer [class]
    module.add_class('ChunkBuffer', import_from_module='ns.video_push')
    ...
    ## neighbor.h (module 'video-push'): ns3::Neighbor [struct]
    module.add_class('Neighbor', import_from_module='ns.video_push')
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData [struct]
    module.add_class('NeighborData', import_from_module='ns.video_push')
    ## neighbor-set.h (module 'video-push'): ns3::NeighborsSet [class]
    module.add_class('NeighborsSet', import_from_module='ns.video_push')
    ...
    ## igmpx-helper.h (module 'igmpx'): ns3::IgmpxHelper [class]
    module.add_class('IgmpxHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    module.add_class('DataCollector', import_from_module='ns.stats', parent=root_module['ns3::Object'])
    ...
    module.add_class('OmnetDataOutput', import_from_module='ns.stats', parent=root_module['ns3::DataOutputInterface'])
    ...
    module.add_class('PacketSizeMinMaxAvgTotalCalculator', import_from_module='ns.stats', parent=root_module['ns3::MinMaxAvgTotalCalculator< unsigned int >'])
    ...
    module.add_class('SqliteDataOutput', import_from_module='ns.stats', parent=root_module['ns3::DataOutputInterface'])
    ...
    module.add_class('TimeMinMaxAvgTotalCalculator', import_from_module='ns.stats', parent=root_module['ns3::DataCalculator'])
    ...
    ## video-push.h (module 'video-push'): ns3::VideoPushApplication [class]
    module.add_class('VideoPushApplication', import_from_module='ns.video_push', parent=root_module['ns3::Application'])
    ...
    ## csv-data-output.h (module 'stats'): ns3::CsvDataOutput [class]
    module.add_class('CsvDataOutput', import_from_module='ns.stats', parent=root_module['ns3::DataOutputInterface'])
    ...
    module.add_class('PacketCounterCalculator', import_from_module='ns.stats', parent=root_module['ns3::CounterCalculator< unsigned int >'])
    module.add_container('std::map< unsigned int, ns3::streaming::ChunkVideo >', ('unsigned int', 'ns3::streaming::ChunkVideo'), container_type='map')
    ...
    ## Register a nested module for the namespace igmpx
    
    nested_module = module.add_cpp_namespace('igmpx')
    register_types_ns3_igmpx(nested_module)
    ...
    ## Register a nested module for the namespace streaming
    
    nested_module = module.add_cpp_namespace('streaming')
    register_types_ns3_streaming(nested_module)
...
def register_types_ns3_igmpx(module):
    root_module = module.get_root()
    
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::PeerRole [enumeration]
    module.add_enum('PeerRole', ['CLIENT', 'ROUTER'])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXType [enumeration]
    module.add_enum('IGMPXType', ['IGMPX_REPORT', 'IGMPX_ACCEPT'])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader [class]
    module.add_class('IGMPXHeader', parent=root_module['ns3::Header'])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage [struct]
    module.add_class('IgmpAcceptMessage', outer_class=root_module['ns3::igmpx::IGMPXHeader'])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage [struct]
    module.add_class('IgmpReportMessage', outer_class=root_module['ns3::igmpx::IGMPXHeader'])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IGMPXRoutingProtocol [class]
    module.add_class('IGMPXRoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState [struct]
    module.add_class('IgmpState')
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair [struct]
    module.add_class('SourceGroupPair')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type='set')
    module.add_container('std::map< unsigned int, ns3::Timer >', ('unsigned int', 'ns3::Timer'), container_type='map')
...
def register_types_ns3_pimdm(module):
    ...
    module.add_enum('AssertWinnerState', ['Assert_NoInfo', 'Assert_Loser', 'Assert_Winner'], import_from_module='ns.pimdm')
    ## pimdm-common.h (module 'pimdm'): ns3::pimdm::Origination [enumeration]
    module.add_enum('Origination', ['NotOriginator', 'Originator'], import_from_module='ns.pimdm')
    ## pimdm-common.h (module 'pimdm'): ns3::pimdm::GraftPruneState [enumeration]
    module.add_enum('GraftPruneState', ['GP_NoInfo', 'GP_Pruned', 'GP_Forwarding', 'GP_AckPending'], import_from_module='ns.pimdm')
    ## pimdm-common.h (module 'pimdm'): ns3::pimdm::AddressFamily [enumeration]
    module.add_enum('AddressFamily', ['AF_Reserved', 'AF_IPv4', 'AF_IPv6', 'AF_NSAP', 'AF_HDLC', 'AF_BBN_1822', 'AF_A802', 'AF_E163', 'AF_E164', 'AF_F69', 'AF_X121', 'AF_IPX', 'AF_Appletalk', 'AF_DecnetIV', 'AF_BanyanVines', 'AF_E164N'], import_from_module='ns.pimdm')
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMType [enumeration]
    module.add_enum('PIMType', ['PIM_HELLO', 'PIM_JP', 'PIM_ASSERT', 'PIM_GRAFT', 'PIM_GRAFT_ACK', 'PIM_STATE_REF'], import_from_module='ns.pimdm')
    ## pimdm-common.h (module 'pimdm'): ns3::pimdm::LocalMembership [enumeration]
    module.add_enum('LocalMembership', ['Local_NoInfo', 'Local_Include'], import_from_module='ns.pimdm')
    ## pimdm-common.h (module 'pimdm'): ns3::pimdm::PruneState [enumeration]
    module.add_enum('PruneState', ['Prune_NoInfo', 'Prune_Pruned', 'Prune_PrunePending'], import_from_module='ns.pimdm')
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::AssertMetric [struct]
    module.add_class('AssertMetric', import_from_module='ns.pimdm')
    ## pimdm-routing.h (module 'pimdm'): ns3::pimdm::IdTag [struct]
    module.add_class('IdTag', import_from_module='ns.pimdm', parent=root_module['ns3::Tag'])
    ## pimdm-routing.h (module 'pimdm'): ns3::pimdm::MulticastEntry [struct]
    module.add_class('MulticastEntry', import_from_module='ns.pimdm')
    ## pimdm-routing.h (module 'pimdm'): ns3::pimdm::MulticastRoutingProtocol [class]
    module.add_class('MulticastRoutingProtocol', import_from_module='ns.pimdm', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::NeighborState [struct]
    module.add_class('NeighborState', import_from_module='ns.pimdm')
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::NeighborhoodStatus [struct]
    module.add_class('NeighborhoodStatus', import_from_module='ns.pimdm')
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader [class]
    module.add_class('PIMHeader', import_from_module='ns.pimdm', parent=root_module['ns3::Header'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::AssertMessage [struct]
    module.add_class('AssertMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::EncodedGroup [struct]
    module.add_class('EncodedGroup', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::EncodedSource [struct]
    module.add_class('EncodedSource', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::EncodedUnicast [struct]
    module.add_class('EncodedUnicast', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::GraftAckMessage [struct]
    module.add_class('GraftAckMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::GraftMessage [struct]
    module.add_class('GraftMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage [struct]
    module.add_class('HelloMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::OptionType [enumeration]
    module.add_enum('OptionType', ['Reserved', 'HelloHoldTime', 'LANPruneDelay', 'AssignedIANA', 'GenerationID', 'StateRefreshCapable', 'BidirCapable'], outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage'], import_from_module='ns.pimdm')
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::HelloEntry [struct]
    module.add_class('HelloEntry', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::HelloEntry::GenerationID [struct]
    module.add_class('GenerationID', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage::HelloEntry'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::HelloEntry::HoldTime [struct]
    module.add_class('HoldTime', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage::HelloEntry'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::HelloEntry::LanPruneDelay [struct]
    module.add_class('LanPruneDelay', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage::HelloEntry'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::HelloMessage::HelloEntry::StateRefreshCapable [struct]
    module.add_class('StateRefreshCapable', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader::HelloMessage::HelloEntry'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::JoinPruneGraftMessage [struct]
    module.add_class('JoinPruneGraftMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::JoinPruneMessage [struct]
    module.add_class('JoinPruneMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::MulticastGroupEntry [struct]
    module.add_class('MulticastGroupEntry', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-packet.h (module 'pimdm'): ns3::pimdm::PIMHeader::StateRefreshMessage [struct]
    module.add_class('StateRefreshMessage', import_from_module='ns.pimdm', outer_class=root_module['ns3::pimdm::PIMHeader'])
    ## pimdm-routing.h (module 'pimdm'): ns3::pimdm::RelayTag [struct]
    module.add_class('RelayTag', import_from_module='ns.pimdm', parent=root_module['ns3::Tag'])
    ## pimdm-routing.h (module 'pimdm'): ns3::pimdm::RoutingMulticastTable [struct]
    module.add_class('RoutingMulticastTable', import_from_module='ns.pimdm')
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::SourceGroupPair [struct]
    module.add_class('SourceGroupPair', import_from_module='ns.pimdm')
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::SourceGroupState [struct]
    module.add_class('SourceGroupState', import_from_module='ns.pimdm')
    ## pimdm-structure.h (module 'pimdm'): ns3::pimdm::UpstreamState [struct]
    module.add_class('UpstreamState', import_from_module='ns.pimdm')
...
def register_types_ns3_streaming(module):
    root_module = module.get_root()
    
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader [class]
    module.add_class('ChunkHeader', import_from_module='ns.video_push', parent=root_module['ns3::Header'])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkMessage [struct]
    module.add_class('ChunkMessage', allow_subclassing=True, import_from_module='ns.video_push', outer_class=root_module['ns3::streaming::ChunkHeader'])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage [struct]
    module.add_class('HelloMessage', allow_subclassing=True, import_from_module='ns.video_push', outer_class=root_module['ns3::streaming::ChunkHeader'])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::PullMessage [struct]
    module.add_class('PullMessage', allow_subclassing=True, import_from_module='ns.video_push', outer_class=root_module['ns3::streaming::ChunkHeader'])
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo [struct]
    module.add_class('ChunkVideo', import_from_module='ns.video_push')
...
def register_methods(root_module):
    ...
    register_Ns3ChunkBuffer_methods(root_module, root_module['ns3::ChunkBuffer'])
    ...
    register_Ns3Neighbor_methods(root_module, root_module['ns3::Neighbor'])
    register_Ns3NeighborData_methods(root_module, root_module['ns3::NeighborData'])
    register_Ns3NeighborsSet_methods(root_module, root_module['ns3::NeighborsSet'])
    ...
    register_Ns3IgmpxHelper_methods(root_module, root_module['ns3::IgmpxHelper'])
    ...
    register_Ns3VideoPushApplication_methods(root_module, root_module['ns3::VideoPushApplication'])
    ...
    register_Ns3CsvDataOutput_methods(root_module, root_module['ns3::CsvDataOutput'])
    ...
    register_Ns3IgmpxIGMPXHeader_methods(root_module, root_module['ns3::igmpx::IGMPXHeader'])
    register_Ns3IgmpxIGMPXHeaderIgmpAcceptMessage_methods(root_module, root_module['ns3::igmpx::IGMPXHeader::IgmpAcceptMessage'])
    register_Ns3IgmpxIGMPXHeaderIgmpReportMessage_methods(root_module, root_module['ns3::igmpx::IGMPXHeader::IgmpReportMessage'])
    register_Ns3IgmpxIGMPXRoutingProtocol_methods(root_module, root_module['ns3::igmpx::IGMPXRoutingProtocol'])
    register_Ns3IgmpxIgmpState_methods(root_module, root_module['ns3::igmpx::IgmpState'])
    register_Ns3IgmpxSourceGroupPair_methods(root_module, root_module['ns3::igmpx::SourceGroupPair'])
    ...
    register_Ns3StreamingChunkHeader_methods(root_module, root_module['ns3::streaming::ChunkHeader'])
    register_Ns3StreamingChunkHeaderChunkMessage_methods(root_module, root_module['ns3::streaming::ChunkHeader::ChunkMessage'])
    register_Ns3StreamingChunkHeaderHelloMessage_methods(root_module, root_module['ns3::streaming::ChunkHeader::HelloMessage'])
    register_Ns3StreamingChunkHeaderPullMessage_methods(root_module, root_module['ns3::streaming::ChunkHeader::PullMessage'])
    register_Ns3StreamingChunkVideo_methods(root_module, root_module['ns3::streaming::ChunkVideo'])
    return
...
def register_Ns3ChunkBuffer_methods(root_module, cls):
    ## chunk-buffer.h (module 'video-push'): ns3::ChunkBuffer::ChunkBuffer(ns3::ChunkBuffer const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::ChunkBuffer const &', 'arg0')])
    ## chunk-buffer.h (module 'video-push'): ns3::ChunkBuffer::ChunkBuffer() [constructor]
    cls.add_constructor([])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::AddChunk(ns3::streaming::ChunkVideo const & chunk, ChunkState state) [member function]
    cls.add_method('AddChunk', 
                   'bool', 
                   [param('ns3::streaming::ChunkVideo const &', 'chunk'), param('ChunkState', 'state')])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::ChunkDelayed(uint32_t chunkid) [member function]
    cls.add_method('ChunkDelayed', 
                   'bool', 
                   [param('uint32_t', 'chunkid')])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::ChunkMissed(uint32_t chunkid) [member function]
    cls.add_method('ChunkMissed', 
                   'bool', 
                   [param('uint32_t', 'chunkid')])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::ChunkSkipped(uint32_t chunkid) [member function]
    cls.add_method('ChunkSkipped', 
                   'bool', 
                   [param('uint32_t', 'chunkid')])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::DelChunk(uint32_t index) [member function]
    cls.add_method('DelChunk', 
                   'bool', 
                   [param('uint32_t', 'index')])
    ## chunk-buffer.h (module 'video-push'): size_t const ns3::ChunkBuffer::GetBufferSize() [member function]
    cls.add_method('GetBufferSize', 
                   'size_t const', 
                   [])
    ## chunk-buffer.h (module 'video-push'): ns3::streaming::ChunkVideo * ns3::ChunkBuffer::GetChunk(uint32_t index) [member function]
    cls.add_method('GetChunk', 
                   'ns3::streaming::ChunkVideo *', 
                   [param('uint32_t', 'index')])
    ## chunk-buffer.h (module 'video-push'): std::map<unsigned int, ns3::streaming::ChunkVideo, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, ns3::streaming::ChunkVideo> > > ns3::ChunkBuffer::GetChunkBuffer() [member function]
    cls.add_method('GetChunkBuffer', 
                   'std::map< unsigned int, ns3::streaming::ChunkVideo >', 
                   [])
    ## chunk-buffer.h (module 'video-push'): ChunkState ns3::ChunkBuffer::GetChunkState(uint32_t index) [member function]
    cls.add_method('GetChunkState', 
                   'ChunkState', 
                   [param('uint32_t', 'index')])
    ## chunk-buffer.h (module 'video-push'): uint32_t ns3::ChunkBuffer::GetLastChunk() [member function]
    cls.add_method('GetLastChunk', 
                   'uint32_t', 
                   [])
    ## chunk-buffer.h (module 'video-push'): uint32_t ns3::ChunkBuffer::GetLatestMissed(uint32_t base, uint32_t window) [member function]
    cls.add_method('GetLatestMissed', 
                   'uint32_t', 
                   [param('uint32_t', 'base'), param('uint32_t', 'window')])
    ## chunk-buffer.h (module 'video-push'): uint32_t ns3::ChunkBuffer::GetLeastMissed(uint32_t base, uint32_t window) [member function]
    cls.add_method('GetLeastMissed', 
                   'uint32_t', 
                   [param('uint32_t', 'base'), param('uint32_t', 'window')])
    ## chunk-buffer.h (module 'video-push'): bool ns3::ChunkBuffer::HasChunk(uint32_t index) [member function]
    cls.add_method('HasChunk', 
                   'bool', 
                   [param('uint32_t', 'index')])
    ## chunk-buffer.h (module 'video-push'): std::string ns3::ChunkBuffer::PrintBuffer() [member function]
    cls.add_method('PrintBuffer', 
                   'std::string', 
                   [])
    ## chunk-buffer.h (module 'video-push'): void ns3::ChunkBuffer::SetChunkState(uint32_t chunkid, ChunkState state) [member function]
    cls.add_method('SetChunkState', 
                   'void', 
                   [param('uint32_t', 'chunkid'), param('ChunkState', 'state')])
    return
...
def register_Ns3DataOutputCallback_methods(root_module, cls):
    ...
    cls.add_method('OutputSingleton', 
                   ...
                   is_pure_virtual=True, is_virtual=True)
    ## data-output-interface.h (module 'stats'): void ns3::DataOutputCallback::OutputSingleton(std::string key, std::string variable, uint32_t val, uint32_t count) [member function]
    cls.add_method('OutputSingleton', 
                   'void', 
                   [param('std::string', 'key'), param('std::string', 'variable'), param('uint32_t', 'val'), param('uint32_t', 'count')], 
                   is_pure_virtual=True, is_virtual=True)
...
def register_Ns3Neighbor_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## neighbor.h (module 'video-push'): ns3::Neighbor::Neighbor(ns3::Neighbor const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::Neighbor const &', 'arg0')])
    ## neighbor.h (module 'video-push'): ns3::Neighbor::Neighbor() [constructor]
    cls.add_constructor([])
    ## neighbor.h (module 'video-push'): ns3::Neighbor::Neighbor(ns3::Ipv4Address n, uint32_t i) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'n'), param('uint32_t', 'i')])
    ## neighbor.h (module 'video-push'): ns3::Ipv4Address ns3::Neighbor::GetAddress() [member function]
    cls.add_method('GetAddress', 
                   'ns3::Ipv4Address', 
                   [])
    ## neighbor.h (module 'video-push'): uint32_t ns3::Neighbor::GetPort() [member function]
    cls.add_method('GetPort', 
                   'uint32_t', 
                   [])
    ## neighbor.h (module 'video-push'): ns3::Neighbor::n_address [variable]
    cls.add_instance_attribute('n_address', 'ns3::Ipv4Address', is_const=False)
    ## neighbor.h (module 'video-push'): ns3::Neighbor::n_port [variable]
    cls.add_instance_attribute('n_port', 'uint32_t', is_const=False)
    return

def register_Ns3NeighborData_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::NeighborData(ns3::NeighborData const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::NeighborData const &', 'arg0')])
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::NeighborData() [constructor]
    cls.add_constructor([])
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::NeighborData(ns3::Time start, ns3::PeerState state, uint32_t size, uint32_t c_id, double sinr, double cratio) [constructor]
    cls.add_constructor([param('ns3::Time', 'start'), param('ns3::PeerState', 'state'), param('uint32_t', 'size'), param('uint32_t', 'c_id'), param('double', 'sinr'), param('double', 'cratio')])
    ## neighbor-set.h (module 'video-push'): uint32_t ns3::NeighborData::GetBufferSize() const [member function]
    cls.add_method('GetBufferSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): double ns3::NeighborData::GetChunkRatio() const [member function]
    cls.add_method('GetChunkRatio', 
                   'double', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): uint32_t ns3::NeighborData::GetLastChunk() const [member function]
    cls.add_method('GetLastChunk', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): ns3::Time ns3::NeighborData::GetLastContact() const [member function]
    cls.add_method('GetLastContact', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): ns3::PeerState ns3::NeighborData::GetPeerState() const [member function]
    cls.add_method('GetPeerState', 
                   'ns3::PeerState', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): double ns3::NeighborData::GetSINR() const [member function]
    cls.add_method('GetSINR', 
                   'double', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetBufferSize(uint32_t size) [member function]
    cls.add_method('SetBufferSize', 
                   'void', 
                   [param('uint32_t', 'size')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetChunkRatio(double ratio) [member function]
    cls.add_method('SetChunkRatio', 
                   'void', 
                   [param('double', 'ratio')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetLastChunk(uint32_t last) [member function]
    cls.add_method('SetLastChunk', 
                   'void', 
                   [param('uint32_t', 'last')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetLastContact(ns3::Time contact) [member function]
    cls.add_method('SetLastContact', 
                   'void', 
                   [param('ns3::Time', 'contact')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetPeerState(ns3::PeerState state) [member function]
    cls.add_method('SetPeerState', 
                   'void', 
                   [param('ns3::PeerState', 'state')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::SetSINR(double sinr) [member function]
    cls.add_method('SetSINR', 
                   'void', 
                   [param('double', 'sinr')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborData::Update(uint32_t size, uint32_t last, double ratio) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('uint32_t', 'size'), param('uint32_t', 'last'), param('double', 'ratio')])
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_bufferSize [variable]
    cls.add_instance_attribute('n_bufferSize', 'uint32_t', is_const=False)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_chunksRatio [variable]
    cls.add_instance_attribute('n_chunksRatio', 'double', is_const=False)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_contact [variable]
    cls.add_instance_attribute('n_contact', 'ns3::Time', is_const=False)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_latestChunk [variable]
    cls.add_instance_attribute('n_latestChunk', 'uint32_t', is_const=False)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_sinr [variable]
    cls.add_instance_attribute('n_sinr', 'double', is_const=False)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData::n_state [variable]
    cls.add_instance_attribute('n_state', 'ns3::PeerState', is_const=False)
    return

def register_Ns3NeighborsSet_methods(root_module, cls):
    ## neighbor-set.h (module 'video-push'): ns3::NeighborsSet::NeighborsSet(ns3::NeighborsSet const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::NeighborsSet const &', 'arg0')])
    ## neighbor-set.h (module 'video-push'): ns3::NeighborsSet::NeighborsSet() [constructor]
    cls.add_constructor([])
    ## neighbor-set.h (module 'video-push'): bool ns3::NeighborsSet::AddNeighbor(ns3::Neighbor const neighbor, ns3::NeighborData data) [member function]
    cls.add_method('AddNeighbor', 
                   'bool', 
                   [param('ns3::Neighbor const', 'neighbor'), param('ns3::NeighborData', 'data')])
    ## neighbor-set.h (module 'video-push'): bool ns3::NeighborsSet::AddNeighbor(ns3::Neighbor neighbor) [member function]
    cls.add_method('AddNeighbor', 
                   'bool', 
                   [param('ns3::Neighbor', 'neighbor')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::ClearNeighborhood() [member function]
    cls.add_method('ClearNeighborhood', 
                   'void', 
                   [])
    ## neighbor-set.h (module 'video-push'): bool ns3::NeighborsSet::DelNeighbor(ns3::Ipv4Address n_addr, uint32_t n_iface) [member function]
    cls.add_method('DelNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'n_addr'), param('uint32_t', 'n_iface')])
    ## neighbor-set.h (module 'video-push'): bool ns3::NeighborsSet::DelNeighbor(ns3::Neighbor neighbor) [member function]
    cls.add_method('DelNeighbor', 
                   'bool', 
                   [param('ns3::Neighbor', 'neighbor')])
    ## neighbor-set.h (module 'video-push'): ns3::Neighbor ns3::NeighborsSet::Get(uint32_t index) [member function]
    cls.add_method('Get', 
                   'ns3::Neighbor', 
                   [param('uint32_t', 'index')])
    ## neighbor-set.h (module 'video-push'): ns3::Time ns3::NeighborsSet::GetExpire() const [member function]
    cls.add_method('GetExpire', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData * ns3::NeighborsSet::GetNeighbor(ns3::Ipv4Address n_addr, uint32_t n_iface) [member function]
    cls.add_method('GetNeighbor', 
                   'ns3::NeighborData *', 
                   [param('ns3::Ipv4Address', 'n_addr'), param('uint32_t', 'n_iface')])
    ## neighbor-set.h (module 'video-push'): ns3::NeighborData * ns3::NeighborsSet::GetNeighbor(ns3::Neighbor neighbor) [member function]
    cls.add_method('GetNeighbor', 
                   'ns3::NeighborData *', 
                   [param('ns3::Neighbor', 'neighbor')])
    ## neighbor-set.h (module 'video-push'): double ns3::NeighborsSet::GetSelectionWeight() const [member function]
    cls.add_method('GetSelectionWeight', 
                   'double', 
                   [], 
                   is_const=True)
    ## neighbor-set.h (module 'video-push'): size_t ns3::NeighborsSet::GetSize() [member function]
    cls.add_method('GetSize', 
                   'size_t', 
                   [])
    ## neighbor-set.h (module 'video-push'): bool ns3::NeighborsSet::IsNeighbor(ns3::Neighbor const neighbor) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Neighbor const', 'neighbor')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## neighbor-set.h (module 'video-push'): ns3::Neighbor ns3::NeighborsSet::SelectNeighbor(ns3::PeerPolicy policy) [member function]
    cls.add_method('SelectNeighbor', 
                   'ns3::Neighbor', 
                   [param('ns3::PeerPolicy', 'policy')])
    ## neighbor-set.h (module 'video-push'): ns3::Neighbor ns3::NeighborsSet::SelectPeer(ns3::PeerPolicy policy) [member function]
    cls.add_method('SelectPeer', 
                   'ns3::Neighbor', 
                   [param('ns3::PeerPolicy', 'policy')])
    ## neighbor-set.h (module 'video-push'): ns3::Neighbor ns3::NeighborsSet::SelectRandom() [member function]
    cls.add_method('SelectRandom', 
                   'ns3::Neighbor', 
                   [])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::SetExpire(ns3::Time time) [member function]
    cls.add_method('SetExpire', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::SetSelectionWeight(double weight) [member function]
    cls.add_method('SetSelectionWeight', 
                   'void', 
                   [param('double', 'weight')])
    ## neighbor-set.h (module 'video-push'): void ns3::NeighborsSet::SortNeighborhood(ns3::PeerPolicy policy) [member function]
    cls.add_method('SortNeighborhood', 
                   'void', 
                   [param('ns3::PeerPolicy', 'policy')])
    return
...
def register_Ns3IgmpxHelper_methods(root_module, cls):
    ## igmpx-helper.h (module 'igmpx'): ns3::IgmpxHelper::IgmpxHelper() [constructor]
    cls.add_constructor([])
    ## igmpx-helper.h (module 'igmpx'): ns3::IgmpxHelper::IgmpxHelper(ns3::IgmpxHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::IgmpxHelper const &', 'arg0')])
    ## igmpx-helper.h (module 'igmpx'): ns3::IgmpxHelper * ns3::IgmpxHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::IgmpxHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## igmpx-helper.h (module 'igmpx'): void ns3::IgmpxHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## igmpx-helper.h (module 'igmpx'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::IgmpxHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## igmpx-helper.h (module 'igmpx'): void ns3::IgmpxHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3PacketSizeMinMaxAvgTotalCalculator_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## packet-data-calculators.h (module 'stats'): void ns3::PacketSizeMinMaxAvgTotalCalculator::FrameUpdate(std::string path, ns3::Ptr<ns3::Packet const> packet, ns3::Mac48Address realto) [member function]
    cls.add_method('FrameUpdate', 
                   'void', 
                   [param('std::string', 'path'), param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::Mac48Address', 'realto')])
    ## packet-data-calculators.h (module 'stats'): void ns3::PacketSizeMinMaxAvgTotalCalculator::PacketUpdate(std::string path, ns3::Ptr<ns3::Packet const> packet) [member function]
...
def register_Ns3VideoPushApplication_methods(root_module, cls):
    ## video-push.h (module 'video-push'): ns3::VideoPushApplication::VideoPushApplication(ns3::VideoPushApplication const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::VideoPushApplication const &', 'arg0')])
    ## video-push.h (module 'video-push'): ns3::VideoPushApplication::VideoPushApplication() [constructor]
    cls.add_constructor([])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::AddPullRetry(uint32_t chunkid) [member function]
    cls.add_method('AddPullRetry', 
                   'void', 
                   [param('uint32_t', 'chunkid')])
    ## video-push.h (module 'video-push'): std::list<ns3::Ptr<ns3::Socket>, std::allocator<ns3::Ptr<ns3::Socket> > > ns3::VideoPushApplication::GetAcceptedSockets() const [member function]
    cls.add_method('GetAcceptedSockets', 
                   'std::list< ns3::Ptr< ns3::Socket > >', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): ns3::Time ns3::VideoPushApplication::GetChunkDelay(uint32_t chunkid) [member function]
    cls.add_method('GetChunkDelay', 
                   'ns3::Time', 
                   [param('uint32_t', 'chunkid')])
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetHelloActive() const [member function]
    cls.add_method('GetHelloActive', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetHelloLoss() const [member function]
    cls.add_method('GetHelloLoss', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): ns3::Time ns3::VideoPushApplication::GetHelloTime() const [member function]
    cls.add_method('GetHelloTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): ns3::Ptr<ns3::Socket> ns3::VideoPushApplication::GetListeningSocket() const [member function]
    cls.add_method('GetListeningSocket', 
                   'ns3::Ptr< ns3::Socket >', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): bool ns3::VideoPushApplication::GetPullActive() const [member function]
    cls.add_method('GetPullActive', 
                   'bool', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetPullCReply() const [member function]
    cls.add_method('GetPullCReply', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetPullMReply() const [member function]
    cls.add_method('GetPullMReply', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetPullMax() const [member function]
    cls.add_method('GetPullMax', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): double ns3::VideoPushApplication::GetPullRatioMax() const [member function]
    cls.add_method('GetPullRatioMax', 
                   'double', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): double ns3::VideoPushApplication::GetPullRatioMin() const [member function]
    cls.add_method('GetPullRatioMin', 
                   'double', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetPullRetry(uint32_t chunkid) [member function]
    cls.add_method('GetPullRetry', 
                   'uint32_t', 
                   [param('uint32_t', 'chunkid')])
    ## video-push.h (module 'video-push'): ns3::Time ns3::VideoPushApplication::GetPullTime() const [member function]
    cls.add_method('GetPullTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetPullWindow() const [member function]
    cls.add_method('GetPullWindow', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): ns3::Ipv4Address ns3::VideoPushApplication::GetSource() const [member function]
    cls.add_method('GetSource', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): uint32_t ns3::VideoPushApplication::GetTotalRx() const [member function]
    cls.add_method('GetTotalRx', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): ns3::Ptr<ns3::Socket> ns3::VideoPushApplication::GetTxSocket() const [member function]
    cls.add_method('GetTxSocket', 
                   'ns3::Ptr< ns3::Socket >', 
                   [], 
                   is_const=True)
    ## video-push.h (module 'video-push'): static ns3::TypeId ns3::VideoPushApplication::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## video-push.h (module 'video-push'): bool ns3::VideoPushApplication::PullRange() [member function]
    cls.add_method('PullRange', 
                   'bool', 
                   [])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::ResetPullCReply() [member function]
    cls.add_method('ResetPullCReply', 
                   'void', 
                   [])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetChunkDelay(uint32_t chunkid, ns3::Time delay) [member function]
    cls.add_method('SetChunkDelay', 
                   'void', 
                   [param('uint32_t', 'chunkid'), param('ns3::Time', 'delay')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetDelayTracker(ns3::Ptr<ns3::TimeMinMaxAvgTotalCalculator> delay) [member function]
    cls.add_method('SetDelayTracker', 
                   'void', 
                   [param('ns3::Ptr< ns3::TimeMinMaxAvgTotalCalculator >', 'delay')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetGateway(ns3::Ipv4Address const & gateway) [member function]
    cls.add_method('SetGateway', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'gateway')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetHelloActive(uint32_t hello) [member function]
    cls.add_method('SetHelloActive', 
                   'void', 
                   [param('uint32_t', 'hello')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetHelloLoss(uint32_t loss) [member function]
    cls.add_method('SetHelloLoss', 
                   'void', 
                   [param('uint32_t', 'loss')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetHelloTime(ns3::Time time) [member function]
    cls.add_method('SetHelloTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetMaxBytes(uint32_t maxBytes) [member function]
    cls.add_method('SetMaxBytes', 
                   'void', 
                   [param('uint32_t', 'maxBytes')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullActive(bool pull) [member function]
    cls.add_method('SetPullActive', 
                   'void', 
                   [param('bool', 'pull')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullCReply(uint32_t value) [member function]
    cls.add_method('SetPullCReply', 
                   'void', 
                   [param('uint32_t', 'value')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullMReply(uint32_t value) [member function]
    cls.add_method('SetPullMReply', 
                   'void', 
                   [param('uint32_t', 'value')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullMax(uint32_t max) [member function]
    cls.add_method('SetPullMax', 
                   'void', 
                   [param('uint32_t', 'max')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullRatioMax(double ratio) [member function]
    cls.add_method('SetPullRatioMax', 
                   'void', 
                   [param('double', 'ratio')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullRatioMin(double ratio) [member function]
    cls.add_method('SetPullRatioMin', 
                   'void', 
                   [param('double', 'ratio')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullTime(ns3::Time time) [member function]
    cls.add_method('SetPullTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetPullWindow(uint32_t window) [member function]
    cls.add_method('SetPullWindow', 
                   'void', 
                   [param('uint32_t', 'window')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::SetSource(ns3::Ipv4Address source) [member function]
    cls.add_method('SetSource', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source')])
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::StartApplication() [member function]
    cls.add_method('StartApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## video-push.h (module 'video-push'): void ns3::VideoPushApplication::StopApplication() [member function]
    cls.add_method('StopApplication', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
...
def register_Ns3CsvDataOutput_methods(root_module, cls):
    ## csv-data-output.h (module 'stats'): ns3::CsvDataOutput::CsvDataOutput(ns3::CsvDataOutput const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::CsvDataOutput const &', 'arg0')])
    ## csv-data-output.h (module 'stats'): ns3::CsvDataOutput::CsvDataOutput() [constructor]
    cls.add_constructor([])
    ## csv-data-output.h (module 'stats'): void ns3::CsvDataOutput::Output(ns3::DataCollector & dc) [member function]
    cls.add_method('Output', 
                   'void', 
                   [param('ns3::DataCollector &', 'dc')], 
                   is_virtual=True)
    ## csv-data-output.h (module 'stats'): void ns3::CsvDataOutput::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
...
def register_Ns3PacketCounterCalculator_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## packet-data-calculators.h (module 'stats'): void ns3::PacketCounterCalculator::FrameUpdate(std::string path, ns3::Ptr<ns3::Packet const> packet, ns3::Mac48Address realto) [member function]
    cls.add_method('FrameUpdate', 
                   'void', 
                   [param('std::string', 'path'), param('ns3::Ptr< ns3::Packet const >', 'packet'), param('ns3::Mac48Address', 'realto')])
    ## packet-data-calculators.h (module 'stats'): void ns3::PacketCounterCalculator::PacketUpdate(std::string path, ns3::Ptr<ns3::Packet const> packet) [member function]
    cls.add_method('PacketUpdate', 
                   'void', 
                   [param('std::string', 'path'), param('ns3::Ptr< ns3::Packet const >', 'packet')])
...
def register_Ns3IgmpxIGMPXHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IGMPXHeader(ns3::igmpx::IGMPXHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::IGMPXHeader const &', 'arg0')])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IGMPXHeader() [constructor]
    cls.add_constructor([])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IGMPXHeader(ns3::igmpx::IGMPXType type) [constructor]
    cls.add_constructor([param('ns3::igmpx::IGMPXType', 'type')])
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage & ns3::igmpx::IGMPXHeader::GetIgmpAcceptMessage() [member function]
    cls.add_method('GetIgmpAcceptMessage', 
                   'ns3::igmpx::IGMPXHeader::IgmpAcceptMessage &', 
                   [])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage & ns3::igmpx::IGMPXHeader::GetIgmpReportMessage() [member function]
    cls.add_method('GetIgmpReportMessage', 
                   'ns3::igmpx::IGMPXHeader::IgmpReportMessage &', 
                   [])
    ## igmpx-packet.h (module 'igmpx'): ns3::TypeId ns3::igmpx::IGMPXHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXType ns3::igmpx::IGMPXHeader::GetType() const [member function]
    cls.add_method('GetType', 
                   'ns3::igmpx::IGMPXType', 
                   [], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): static ns3::TypeId ns3::igmpx::IGMPXHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::SetType(ns3::igmpx::IGMPXType type) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('ns3::igmpx::IGMPXType', 'type')])
    return

def register_Ns3IgmpxIGMPXHeaderIgmpAcceptMessage_methods(root_module, cls):
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::IgmpAcceptMessage() [constructor]
    cls.add_constructor([])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::IgmpAcceptMessage(ns3::igmpx::IGMPXHeader::IgmpAcceptMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::IGMPXHeader::IgmpAcceptMessage const &', 'arg0')])
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::m_downstreamAddr [variable]
    cls.add_instance_attribute('m_downstreamAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::m_multicastGroupAddr [variable]
    cls.add_instance_attribute('m_multicastGroupAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpAcceptMessage::m_sourceAddr [variable]
    cls.add_instance_attribute('m_sourceAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IgmpxIGMPXHeaderIgmpReportMessage_methods(root_module, cls):
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage::IgmpReportMessage() [constructor]
    cls.add_constructor([])
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage::IgmpReportMessage(ns3::igmpx::IGMPXHeader::IgmpReportMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::IGMPXHeader::IgmpReportMessage const &', 'arg0')])
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::IgmpReportMessage::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## igmpx-packet.h (module 'igmpx'): uint32_t ns3::igmpx::IGMPXHeader::IgmpReportMessage::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::IgmpReportMessage::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): void ns3::igmpx::IGMPXHeader::IgmpReportMessage::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage::m_multicastGroupAddr [variable]
    cls.add_instance_attribute('m_multicastGroupAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage::m_sourceAddr [variable]
    cls.add_instance_attribute('m_sourceAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-packet.h (module 'igmpx'): ns3::igmpx::IGMPXHeader::IgmpReportMessage::m_upstreamAddr [variable]
    cls.add_instance_attribute('m_upstreamAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3IgmpxIGMPXRoutingProtocol_methods(root_module, cls):
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IGMPXRoutingProtocol::IGMPXRoutingProtocol(ns3::igmpx::IGMPXRoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::IGMPXRoutingProtocol const &', 'arg0')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IGMPXRoutingProtocol::IGMPXRoutingProtocol() [constructor]
    cls.add_constructor([])
    ## igmpx-routing.h (module 'igmpx'): int32_t ns3::igmpx::IGMPXRoutingProtocol::GetMainInterface() [member function]
    cls.add_method('GetMainInterface', 
                   'int32_t', 
                   [])
    ## igmpx-routing.h (module 'igmpx'): static ns3::TypeId ns3::igmpx::IGMPXRoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::registerMember(ns3::Ipv4Address source, ns3::Ipv4Address group, uint32_t interface) [member function]
    cls.add_method('registerMember', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'group'), param('uint32_t', 'interface')])
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::register_member(std::string SGI) [member function]
    cls.add_method('register_member', 
                   'void', 
                   [param('std::string', 'SGI')])
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::unregisterMember(ns3::Ipv4Address source, ns3::Ipv4Address group, uint32_t interface) [member function]
    cls.add_method('unregisterMember', 
                   'void', 
                   [param('ns3::Ipv4Address', 'source'), param('ns3::Ipv4Address', 'group'), param('uint32_t', 'interface')])
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::unregister_member(std::string SGI) [member function]
    cls.add_method('unregister_member', 
                   'void', 
                   [param('std::string', 'SGI')])
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::DoStart() [member function]
    cls.add_method('DoStart', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): bool ns3::igmpx::IGMPXRoutingProtocol::RouteInput(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): ns3::Ptr<ns3::Ipv4Route> ns3::igmpx::IGMPXRoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## igmpx-routing.h (module 'igmpx'): void ns3::igmpx::IGMPXRoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3IgmpxIgmpState_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState::IgmpState(ns3::igmpx::IgmpState const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::IgmpState const &', 'arg0')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState::IgmpState(ns3::igmpx::SourceGroupPair sgp) [constructor]
    cls.add_constructor([param('ns3::igmpx::SourceGroupPair', 'sgp')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState::igmpLife [variable]
    cls.add_instance_attribute('igmpLife', 'ns3::Timer', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState::igmpPair [variable]
    cls.add_instance_attribute('igmpPair', 'ns3::igmpx::SourceGroupPair', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::IgmpState::igmpReport [variable]
    cls.add_instance_attribute('igmpReport', 'std::map< unsigned int, ns3::Timer >', is_const=False)
    return

def register_Ns3IgmpxSourceGroupPair_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::SourceGroupPair(ns3::igmpx::SourceGroupPair const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::igmpx::SourceGroupPair const &', 'arg0')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::SourceGroupPair() [constructor]
    cls.add_constructor([])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::SourceGroupPair(ns3::Ipv4Address s, ns3::Ipv4Address g) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 's'), param('ns3::Ipv4Address', 'g')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::SourceGroupPair(ns3::Ipv4Address s, ns3::Ipv4Address g, ns3::Ipv4Address n) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 's'), param('ns3::Ipv4Address', 'g'), param('ns3::Ipv4Address', 'n')])
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::groupMulticastAddr [variable]
    cls.add_instance_attribute('groupMulticastAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::m_renew [variable]
    cls.add_instance_attribute('m_renew', 'ns3::Timer', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::nextMulticastAddr [variable]
    cls.add_instance_attribute('nextMulticastAddr', 'ns3::Ipv4Address', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::snrNext [variable]
    cls.add_instance_attribute('snrNext', 'double', is_const=False)
    ## igmpx-routing.h (module 'igmpx'): ns3::igmpx::SourceGroupPair::sourceMulticastAddr [variable]
...
def register_Ns3StreamingChunkHeader_methods(root_module, cls):
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkHeader(ns3::streaming::ChunkHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::streaming::ChunkHeader const &', 'arg0')])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkHeader(ChunkMessageType type) [constructor]
    cls.add_constructor([param('ChunkMessageType', 'type')])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkHeader() [constructor]
    cls.add_constructor([])
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint16_t ns3::streaming::ChunkHeader::GetChecksum() [member function]
    cls.add_method('GetChecksum', 
                   'uint16_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkMessage & ns3::streaming::ChunkHeader::GetChunkMessage() [member function]
    cls.add_method('GetChunkMessage', 
                   'ns3::streaming::ChunkHeader::ChunkMessage &', 
                   [])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage & ns3::streaming::ChunkHeader::GetHelloMessage() [member function]
    cls.add_method('GetHelloMessage', 
                   'ns3::streaming::ChunkHeader::HelloMessage &', 
                   [])
    ## chunk-packet.h (module 'video-push'): ns3::TypeId ns3::streaming::ChunkHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::PullMessage & ns3::streaming::ChunkHeader::GetPullMessage() [member function]
    cls.add_method('GetPullMessage', 
                   'ns3::streaming::ChunkHeader::PullMessage &', 
                   [])
    ## chunk-packet.h (module 'video-push'): uint8_t ns3::streaming::ChunkHeader::GetReserved() [member function]
    cls.add_method('GetReserved', 
                   'uint8_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ChunkMessageType ns3::streaming::ChunkHeader::GetType() [member function]
    cls.add_method('GetType', 
                   'ChunkMessageType', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): static ns3::TypeId ns3::streaming::ChunkHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::SetChecksum(uint16_t checksum) [member function]
    cls.add_method('SetChecksum', 
                   'void', 
                   [param('uint16_t', 'checksum')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::SetReserved(uint8_t reserved) [member function]
    cls.add_method('SetReserved', 
                   'void', 
                   [param('uint8_t', 'reserved')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::SetType(ChunkMessageType type) [member function]
    cls.add_method('SetType', 
                   'void', 
                   [param('ChunkMessageType', 'type')], 
                   is_virtual=True)
    return

def register_Ns3StreamingChunkHeaderChunkMessage_methods(root_module, cls):
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkMessage::ChunkMessage() [constructor]
    cls.add_constructor([])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkMessage::ChunkMessage(ns3::streaming::ChunkHeader::ChunkMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::streaming::ChunkHeader::ChunkMessage const &', 'arg0')])
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::ChunkMessage::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkVideo ns3::streaming::ChunkHeader::ChunkMessage::GetChunk() [member function]
    cls.add_method('GetChunk', 
                   'ns3::streaming::ChunkVideo', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::ChunkMessage::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::ChunkMessage::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::ChunkMessage::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::ChunkMessage::SetChunk(ns3::streaming::ChunkVideo chunk) [member function]
    cls.add_method('SetChunk', 
                   'void', 
                   [param('ns3::streaming::ChunkVideo', 'chunk')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::ChunkMessage::m_chunk [variable]
    cls.add_instance_attribute('m_chunk', 'ns3::streaming::ChunkVideo', is_const=False)
    return

def register_Ns3StreamingChunkHeaderHelloMessage_methods(root_module, cls):
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage::HelloMessage() [constructor]
    cls.add_constructor([])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage::HelloMessage(ns3::streaming::ChunkHeader::HelloMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::streaming::ChunkHeader::HelloMessage const &', 'arg0')])
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::HelloMessage::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::HelloMessage::GetChunksRatio() [member function]
    cls.add_method('GetChunksRatio', 
                   'uint32_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::HelloMessage::GetChunksReceived() [member function]
    cls.add_method('GetChunksReceived', 
                   'uint32_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::HelloMessage::GetLastChunk() [member function]
    cls.add_method('GetLastChunk', 
                   'uint32_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::HelloMessage::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::HelloMessage::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::HelloMessage::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::HelloMessage::SetChunksRatio(uint32_t chunksRec) [member function]
    cls.add_method('SetChunksRatio', 
                   'void', 
                   [param('uint32_t', 'chunksRec')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::HelloMessage::SetChunksReceived(uint32_t chunksRec) [member function]
    cls.add_method('SetChunksReceived', 
                   'void', 
                   [param('uint32_t', 'chunksRec')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::HelloMessage::SetLastChunk(uint32_t last) [member function]
    cls.add_method('SetLastChunk', 
                   'void', 
                   [param('uint32_t', 'last')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage::m_chunksRatio [variable]
    cls.add_instance_attribute('m_chunksRatio', 'uint32_t', is_const=False)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage::m_chunksRec [variable]
    cls.add_instance_attribute('m_chunksRec', 'uint32_t', is_const=False)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::HelloMessage::m_lastChunk [variable]
    cls.add_instance_attribute('m_lastChunk', 'uint32_t', is_const=False)
    return

def register_Ns3StreamingChunkHeaderPullMessage_methods(root_module, cls):
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::PullMessage::PullMessage() [constructor]
    cls.add_constructor([])
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::PullMessage::PullMessage(ns3::streaming::ChunkHeader::PullMessage const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::streaming::ChunkHeader::PullMessage const &', 'arg0')])
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::PullMessage::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::PullMessage::GetChunk() [member function]
    cls.add_method('GetChunk', 
                   'uint32_t', 
                   [], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): uint32_t ns3::streaming::ChunkHeader::PullMessage::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::PullMessage::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::PullMessage::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## chunk-packet.h (module 'video-push'): void ns3::streaming::ChunkHeader::PullMessage::SetChunk(uint32_t chunkid) [member function]
    cls.add_method('SetChunk', 
                   'void', 
                   [param('uint32_t', 'chunkid')], 
                   is_virtual=True)
    ## chunk-packet.h (module 'video-push'): ns3::streaming::ChunkHeader::PullMessage::m_chunkID [variable]
    cls.add_instance_attribute('m_chunkID', 'uint32_t', is_const=False)
    return

def register_Ns3StreamingChunkVideo_methods(root_module, cls):
    cls.add_binary_comparison_operator('<')
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::ChunkVideo() [constructor]
    cls.add_constructor([])
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::ChunkVideo(ns3::streaming::ChunkVideo const & cv) [copy constructor]
    cls.add_constructor([param('ns3::streaming::ChunkVideo const &', 'cv')])
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::ChunkVideo(uint32_t const cid, uint64_t const ctstamp, uint16_t const csize, uint16_t const cattributes_size) [constructor]
    cls.add_constructor([param('uint32_t const', 'cid'), param('uint64_t const', 'ctstamp'), param('uint16_t const', 'csize'), param('uint16_t const', 'cattributes_size')])
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo * ns3::streaming::ChunkVideo::Copy() [member function]
    cls.add_method('Copy', 
                   'ns3::streaming::ChunkVideo *', 
                   [])
    ## chunk-video.h (module 'video-push'): uint16_t ns3::streaming::ChunkVideo::GetAttributeSize() [member function]
    cls.add_method('GetAttributeSize', 
                   'uint16_t', 
                   [])
    ## chunk-video.h (module 'video-push'): uint16_t ns3::streaming::ChunkVideo::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint16_t', 
                   [])
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::c_attributes_size [variable]
    cls.add_instance_attribute('c_attributes_size', 'uint16_t', is_const=False)
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::c_id [variable]
    cls.add_instance_attribute('c_id', 'uint32_t', is_const=False)
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::c_size [variable]
    cls.add_instance_attribute('c_size', 'uint16_t', is_const=False)
    ## chunk-video.h (module 'video-push'): ns3::streaming::ChunkVideo::c_tstamp [variable]
    cls.add_instance_attribute('c_tstamp', 'uint64_t', is_const=False)
    return
...
def register_functions(root_module):
    ...
    register_functions_ns3_igmpx(module.get_submodule('igmpx'), root_module)
    ...
    register_functions_ns3_streaming(module.get_submodule('streaming'), root_module)
    return
...
def register_functions_ns3_igmpx(module, root_module):
    return
...
def register_functions_ns3_streaming(module, root_module):
    return
